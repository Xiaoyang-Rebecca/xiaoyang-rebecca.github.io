...
Vision Transformers (ViTs) adapt the Transformer architecture (check [previous post](https://xiaoyang-rebecca.github.io/posts/2024/12/blog-post-1/)), originally designed for text processing, to computer vision tasks. Instead of using **convolutional layers** like CNNs, ViTs use **self-attention mechanisms** to process images, allowing them to capture **long-range dependencies** and **contextual information** across an image.
